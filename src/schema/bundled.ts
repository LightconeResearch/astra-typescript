// Generated by scripts/sync-bundled-schema.mjs from https://astra-spec.org/0.0.14/schema/astra.schema.json.
// Do not edit this file by hand.

export const BUNDLED_ASTRA_SPEC_VERSION = "0.0.14" as const;

export const bundledAstraSchema: Record<string, unknown> = {
  "$defs": {
    "Analysis": {
    ...
    "Option": {
      ...
      "properties": {
        "description": {
          "description": "Free-prose description of this option.",
          "type": [
            "string",
            "null"
          ]
    ...
    "Output": {
      ...
      "properties": {
        ...
        "description": {
          "description": "Free-prose description of this output.",
          "type": [
            "string",
            "null"
          ]
        ...
        "format": {
          "description": "Concrete serialization of the artifact, as a lowercase token: the file extension the artifact is written with, without the leading dot (`png`, `pdf`, `svg`, `csv`, `parquet`, `json`, `fits`, `hdf5`, `html`, `md`). Where `type` says what the output *is* (figure, table, data), `format` says how it is encoded, so consumers can render, diff, or open it without inspecting the file.\nThe value space is deliberately open — any lowercase token matching the pattern is legal, so formats specific to a field (`asdf`, `zarr`, `nc`) need no schema change.\nRecommended, not required, in 0.0.x: validators warn when it is missing. It becomes **required** for non-aliased Outputs in 0.1.0. Forbidden when `from` is set (inherited from the source).",
